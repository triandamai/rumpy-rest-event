...
pub async fn init_seeder(database: &Database) {
    ...
    //create index
    {
        ...
        let _idx_account = IndexModel::builder()
        ...
        let _index = &database
            ...
            .create_index(_idx_account)
            .await;
        let _idx_permission = IndexModel::builder()
            .keys(doc! { "value":1 })
            .options(
                IndexOptions::builder()
...
pub fn get_list_permission() -> Vec<Permission> {
    ...
    vec![
        ...
        Permission {
            ...
            value: "app::couch::write".to_string(),
            name: "Write Couch".to_string(),
            description: "Can Create Or Update Couch".to_string(),
            created_at: current_time.clone(),
            updated_at: current_time,
        },
        Permission {
            id: create_or_new_object_id("6742c74a15e68b0e7ee06135"),
            value: "app::couch::read".to_string(),
            name: "Read Couch".to_string(),
            description: "Can Read Couch".to_string(),
            created_at: current_time.clone(),
            updated_at: current_time,
        },
        Permission {
