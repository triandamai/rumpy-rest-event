...
pub fn get_list_permission() -> Vec<Permission> {
    ...
    vec![
        ...
        Permission {
            ...
            value: "app::discount::write".to_string(),
            name: "Write Discount".to_string(),
            group: "Discount".to_string(),
            description: "Can Create Discount".to_string(),
            created_at: current_time.clone(),
            updated_at: current_time,
            deleted: false,
        },
        ...
        Permission {
            ...
            value: "app::stock::write".to_string(),
            name: "Write Stock".to_string(),
            group: "Stock".to_string(),
